...
mod tests {
    ...
    #[test]
    fn test_get_notes_by_id_error_codes() {
        assert_eq!(GetNotesByIdError::Internal as u8, 0);
        assert_eq!(GetNotesByIdError::DeserializationFailed as u8, 1);
        assert_eq!(GetNotesByIdError::NoteNotFound as u8, 2);
        assert_eq!(GetNotesByIdError::NoteNotPublic as u8, 3);
    }

    #[test]
    fn test_get_note_script_by_root_error_codes() {
        assert_eq!(GetNoteScriptByRootError::Internal as u8, 0);
        assert_eq!(GetNoteScriptByRootError::DeserializationFailed as u8, 1);
        assert_eq!(GetNoteScriptByRootError::ScriptNotFound as u8, 2);
    }

    #[test]
    fn test_check_nullifiers_error_codes() {
        assert_eq!(CheckNullifiersError::Internal as u8, 0);
        assert_eq!(CheckNullifiersError::DeserializationFailed as u8, 1);
    }

    #[test]
    fn test_get_notes_by_id_error_from_code() {
        assert_eq!(GetNotesByIdError::from(0), GetNotesByIdError::Internal);
        assert_eq!(GetNotesByIdError::from(1), GetNotesByIdError::DeserializationFailed);
        assert_eq!(GetNotesByIdError::from(2), GetNotesByIdError::NoteNotFound);
        assert_eq!(GetNotesByIdError::from(3), GetNotesByIdError::NoteNotPublic);
        assert_eq!(GetNotesByIdError::from(99), GetNotesByIdError::Internal);
    }
    ...
    #[test]
    fn test_check_nullifiers_error_from_code() {
        assert_eq!(CheckNullifiersError::from(0), CheckNullifiersError::Internal);
        assert_eq!(CheckNullifiersError::from(1), CheckNullifiersError::DeserializationFailed);
        assert_eq!(CheckNullifiersError::from(99), CheckNullifiersError::Internal);
    }
}
