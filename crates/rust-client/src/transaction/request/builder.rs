...
pub struct TransactionRequestBuilder {
    ...
    /// to build the transaction script template. The conversion to [`OutputNote`] (which
    /// distinguishes between public/private) happens at the protocol layer, not here.
