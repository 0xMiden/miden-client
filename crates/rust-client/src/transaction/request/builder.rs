...
use miden_objects::{
    ...
    note::{
        Note, NoteDetails, NoteExecutionMode, NoteId, NoteRecipient, NoteTag, NoteType, PartialNote,
    },
...
pub struct TransactionRequestBuilder {
    ...
    /// A map of expected output note recipients to be generated by the transaction.
