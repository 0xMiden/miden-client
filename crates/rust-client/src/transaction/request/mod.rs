...
pub struct TransactionRequest {
    ...
    /// A list of recipient digests with unknown preimages at transaction generation time
    unknown_output_recipients: Vec<Word>,
...
impl TransactionRequest {
    ...
    pub fn unknown_output_recipients(&self) -> Vec<Word> {
        self.unknown_output_recipients.clone()
    }
...
impl Serializable for TransactionRequest {
    fn write_into<W: ByteWriter>(&self, target: &mut W) {
        ...
        self.unknown_output_recipients.write_into(target);
...
impl Deserializable for TransactionRequest {
    fn read_from<R: ByteReader>(source: &mut R) -> Result<Self, DeserializationError> {
        ...
        let unknown_output_recipients = Vec::<Word>::read_from(source)?;
