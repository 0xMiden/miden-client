...
pub struct TransactionRequest {
    ...
    /// If provided, it will be passed to the transaction executor to enable rich error messages
    /// with source snippets in debug mode.
    source_manager: Option<Arc<dyn SourceManagerSync>>,
}

impl core::cmp::PartialEq for TransactionRequest {
    fn eq(&self, other: &Self) -> bool {
        self.unauthenticated_input_notes == other.unauthenticated_input_notes
            ...
            && self.expected_output_recipients == other.expected_output_recipients
            ...
            && self.foreign_accounts == other.foreign_accounts
            && self.expiration_delta == other.expiration_delta
            && self.ignore_invalid_input_notes == other.ignore_invalid_input_notes
            && self.script_arg == other.script_arg
            && self.auth_arg == other.auth_arg
        // intentionally ignore source_manager in equality
    }
}

impl core::cmp::Eq for TransactionRequest {}
...
impl TransactionRequest {
    ...
    /// Returns the optional source manager associated with this request.
