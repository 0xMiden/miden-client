...
// TODO: replace for derive once
// https://github.com/0xMiden/miden-base/pull/2209
// gets merged
...
impl NoteConsumptionStatus {
    ...
    pub fn never_consumable(_err: String) -> Self {
        todo!() // TODO: How to instantiate?
    }
...
// https://github.com/0xMiden/miden-base/pull/2209
// gets merged
impl Clone for NoteConsumability {
    fn clone(&self) -> Self {
        todo!()
    }
}
