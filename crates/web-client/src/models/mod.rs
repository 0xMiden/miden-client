...
// // (crate::models::provers::Provers) -> ProversArray,
...
// // (crate::models::transaction_script_inputs::TransactionScriptInputs) -> TransactionScriptInputsArray,
