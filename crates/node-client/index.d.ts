...
export declare class Account {
  /** r" Returns the account identifier. */
  id(): AccountId;
  /** r" Returns the commitment to the account header, storage, and code. */
  commitment(): Word;
  /** r" Returns the account nonce. */
  nonce(): Felt;
  /** r" Returns the asset vault for this account. */
  vault(): AssetVault;
  /** r" Returns true if the account is a faucet. */
  isFaucet(): boolean;
  /** r" Returns true if the account is a regular account. */
  isRegularAccount(): boolean;
  /** r" Returns true if the account uses public storage. */
  isPublic(): boolean;
  /** r" Returns true if the account storage is private. */
  isPrivate(): boolean;
  /** r" Returns true if this is a network-owned account. */
  isNetwork(): boolean;
  /** r" Returns true if the account has not yet been committed to the chain. */
  isNew(): boolean;
...
export declare class AccountHeader {
  /** r" Returns the full account commitment. */
  commitment(): Word;
  /** r" Returns the account ID. */
  id(): AccountId;
  /** r" Returns the current nonce. */
  nonce(): Felt;
  /** r" Returns the storage commitment. */
  storageCommitment(): Word;
  /** r" Returns the code commitment. */
  codeCommitment(): Word;
...
export declare class AccountId {
  /** r" Returns true if the ID refers to a faucet. */
  isFaucet(): boolean;
  /** r" Returns true if the ID refers to a regular account. */
  isRegularAccount(): boolean;
  /** r" Returns true if the account uses public storage. */
  isPublic(): boolean;
  /** r" Returns true if the account uses private storage. */
  isPrivate(): boolean;
  /** r" Returns true if the ID is reserved for network accounts. */
  isNetwork(): boolean;
...
export declare class InputNoteRecord {
  /** r" Returns the note ID. */
  id(): NoteId;
  /** r" Returns true if the record contains authentication data (proof). */
  isAuthenticated(): boolean;
  /** r" Returns true if the note has already been consumed. */
  isConsumed(): boolean;
  /** r" Returns true if the note is currently being processed. */
...
export declare class OutputNoteRecord {
  /** r" Returns the note ID. */
  id(): NoteId;
  /** r" Returns the recipient digest committed for the note. */
  recipientDigest(): Word;
  /** r" Returns true if the note has been consumed on chain. */
  isConsumed(): boolean;
  /** r" Returns true if the note is committed on chain. */
  isCommitted(): boolean;
...
export declare class SyncSummary {
  /** r" Returns IDs of notes committed in this sync window. */
  committedNotes(): Array<NoteId>;
  /** r" Returns IDs of notes that were consumed. */
  consumedNotes(): Array<NoteId>;
  /** r" Returns accounts that were updated. */
  updatedAccounts(): Array<AccountId>;
  /** r" Returns transactions that were committed. */
