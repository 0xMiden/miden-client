...
* [BREAKING] Unified note-identity lookups behind a new `NoteRef` enum filled with either the note ID or details commitment ([#TBD](https://github.com/0xMiden/miden-client/pull/TBD)).
