...
* [FEATURE] Added `Client::input_note_reader()` to iterate lazily through consumed input notes in order, with support for filtering by consumer account and block range. ([#1843](https://github.com/0xMiden/miden-client/pull/1843))
