...
* [FIX][rust] `NodeRpcClient::sync_notes` now drops returned notes whose tag was not requested, logging a warning ([#2284](https://github.com/0xMiden/rust-sdk/pull/2284)).
