...
* [BREAKING] Renamed `NodeRpcClient` `get_account_proofs` method to `get_account_proof` & added optional `block_num` parameter (block at which we want to retrieve the proof) ([#1616](https://github.com/0xMiden/miden-client/pull/1616)).
