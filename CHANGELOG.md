...
* Added CLI `package` command to convert `.masm` files into `.masp` packages for use with account creation ([#1132](https://github.com/0xMiden/miden-client/issues/1132)).
