...
* Relaxed store constraints to allow for in-fligth transactions that don't update the account state ([#1335](https://github.com/0xMiden/miden-client/pull/1335)).
