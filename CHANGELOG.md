...
* [FIX][rust] `NodeRpcClient::get_notes_by_id` now drops returned notes whose ID was not requested, logging a warning ([#2283](https://github.com/0xMiden/rust-sdk/pull/2283)).
