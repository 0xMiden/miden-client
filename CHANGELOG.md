...
* Added integration tests for network-transaction public output note creation with a non-standard note script, covering both note-script pre-registration on the node and the unregistered (silently-not-created) case ([#2216](https://github.com/0xMiden/miden-client/pull/2216)).
