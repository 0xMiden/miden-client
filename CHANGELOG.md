...
* Added `miden-cli call` command for invoking account procedures directly from the CLI ([#1943](https://github.com/0xMiden/miden-client/pull/1943)), with typed argument encoding and typed result rendering when the package carries debug type info ([#2179](https://github.com/0xMiden/miden-client/pull/2179)).
