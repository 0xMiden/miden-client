...
* [FEATURE] `send_private_note_by_id()` on `NoteTransportClient` for sending or retrying private-note P2P delivery for a committed note from the local store ([#2061](https://github.com/0xMiden/miden-client/pull/2061)).
