...
* [FIX][rust] Fixed `BlockUpdates::insert` panicking on `debug_assertions=true` builds during `sync_state` when the chain-tip block is also a note-relevant block. ([#2137](https://github.com/0xMiden/miden-client/pull/2137)).
