...
* [BREAKING] Added naming to IndexedDB store to allow multiple web clients to run in the same browser ([#1645](https://github.com/0xMiden/miden-client/pull/1645)).
