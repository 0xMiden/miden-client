...
- `miden-client` runtime library, which provides a std-aware service layer on top of the core primitives. See the [Rust client runtime](./crates/miden-client/README.md) section.
- `miden-client-core` library, a `no_std` friendly implementation shared with the WebClient. See the [core library](./crates/miden-client-core/README.md) section.
